...
class MangaDex(MangaPluginBase):
    ...
    def get_manga(self, url):
        return self.get_manga_dict()
    
    def get_chapter(self, url):
        return self.get_chapter_dict()
    
    def get_volume(self, url):
        return self.get_volume_dict()
    
    def get_volumes(self, url):
        return [self.get_volumes_dict()]
    
    def get_chapters(self, url):
        return [self.get_chapters_dict()]
    
    def get_pages(self, url):
        return [self.get_pages_dict()]